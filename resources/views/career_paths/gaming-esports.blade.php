...
@section('title', 'Gaming & E-sports Career Paths | Career Gyan')
...
<section class="sp-hero">
    <div class="container" style="position:relative;z-index:2;">
        ...
        <h1 style="font-family:'Sora';font-size:clamp(30px,6vw,56px);font-weight:900;margin-bottom:16px;color:#fff;">
            Gaming & E-sports Careers
        </h1>
        <p style="font-size:clamp(15px,2vw,20px);opacity:.9;max-width:760px;margin:0 auto;color:#e2e8f0;line-height:1.7;">
            Explore high-growth careers in gaming development, esports competition, streaming, and production.
        </p>
    </div>
</section>
...
<div class="container">
    ...
    <h2 style="font-family:'Sora';font-size:clamp(20px,3vw,30px);font-weight:800;margin-bottom:40px;text-align:center;color:#fff;">
        Explore Gaming & E-sports Career Paths
    </h2>
    ...
    <div class="career-path-grid">
        ...
        <a href="{{ route('career.detail.page', $path->slug) }}" class="path-card">
            <div class="path-img-wrapper">
                <img
                    src="{{ asset($path->image ?? 'images/default-career.jpg') }}"
                    alt="{{ $path->name }}"
                    class="path-img"
                    loading="lazy"
                    onerror="this.onerror=null;this.src='{{ asset('images/default-career.jpg') }}';"
                >
                <div class="path-icon">
                    <i class="fa-solid {{ $path->icon ?? 'fa-gamepad' }}"></i>
                </div>
