...
@section('title', 'Medical & Healthcare Career Paths | Career Gyan')
...
<style>
    ...
    /* ── Hero ── */
    .med-hero {
        background: linear-gradient(135deg, #164e63 0%, #0e7490 40%, #0891b2 75%, #06b6d4 100%);
    ...
    .path-card:hover {
        ...
        box-shadow: 0 30px 60px rgba(6,182,212,.3);
    ...
    .path-icon {
        ...
        width: 42px; height: 42px; background: rgba(6,182,212,.85);
    ...
    .view-details {
        ...
        color: var(--med-primary); font-weight: 700; font-size: 14.5px; transition: all .3s;
    }
    .path-card:hover .view-details { gap: 13px; color: #38bdf8; }
    ...
    .pagination .active .page-link { background: #06b6d4; border-color: #06b6d4; color: #fff; }
    .pagination { justify-content: center; margin-bottom: 60px; }

    @media(max-width:768px) {
        .med-hero { padding: 80px 0 80px; border-radius: 0 0 40px 40px; }
...
<section class="med-hero">
    <div class="container" style="position:relative;z-index:2;">
        ...
        <p style="font-size:clamp(15px,2vw,20px);opacity:.9;max-width:760px;margin:0 auto;color:#cffafe;line-height:1.7;">
            Heal lives. Shape futures. Explore the most impactful careers in India's rapidly growing healthcare sector.
        </p>
    </div>
</section>
...
<div class="container">
    ...
    <h2 style="font-family:'Sora';font-size:clamp(20px,3vw,30px);font-weight:800;margin-bottom:40px;text-align:center;color:#fff;">
        Explore Medical & Healthcare Career Paths
    </h2>
    ...
    <div class="career-path-grid">
        ...
        <a href="{{ route('career.detail.page', $path->slug) }}" class="path-card">
            <div class="path-img-wrapper">
                <img
                    src="{{ $path->image ?? 'https://images.unsplash.com/photo-1559757148-5c350d0d3c56?auto=format&fit=crop&w=600&q=80' }}"
                    alt="{{ $path->name }}"
                    class="path-img"
                    loading="lazy"
                    onerror="this.onerror=null;this.src='https://images.unsplash.com/photo-1559757148-5c350d0d3c56?auto=format&fit=crop&w=600&q=80';"
                >
                <div class="path-icon">
                    <i class="fa-solid {{ $path->icon ?? 'fa-stethoscope' }}"></i>
                </div>
    ...
    <div style="text-align:center;margin-bottom:80px;">
        <a href="{{ route('explore.index') }}"
           style="display:inline-block;padding:18px 52px;font-size:16px;border-radius:30px;
                  background:linear-gradient(to right,#0891b2,#06b6d4);color:#fff;font-weight:700;
                  box-shadow:0 12px 30px rgba(6,182,212,.4);text-decoration:none;">
