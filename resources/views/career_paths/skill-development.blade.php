...
@section('title', 'Skill Development Career Paths | Career Gyan')
...
<style>
    ...
    /* ── Hero ── */
    .sk-hero {
        background: linear-gradient(135deg, #1e1b4b 0%, #4c1d95 40%, #7c3aed 75%, #8b5cf6 100%);
    ...
    .path-icon {
        ...
        width: 42px; height: 42px; background: rgba(139,92,246,.85);
    ...
    .view-details {
        ...
        color: var(--sk-primary); font-weight: 700; font-size: 14.5px; transition: all .3s;
    }
    .path-card:hover .view-details { gap: 13px; color: #a78bfa; }
    ...
    @media(max-width:768px) {
        .sk-hero { padding: 80px 0 80px; border-radius: 0 0 40px 40px; }
...
<section class="sk-hero">
    <div class="container" style="position:relative;z-index:2;">
        ...
        <p style="font-size:clamp(15px,2vw,20px);opacity:.9;max-width:760px;margin:0 auto;color:#ede9fe;line-height:1.7;">
            Build practical skills. Earn certifications. Launch a rewarding career under India's Skill India Mission — no degree required.
        </p>
    </div>
</section>
...
<div class="container">
    ...
    <div class="stats-container">
        <div class="stat-box">
            ...
            <div class="stat-label">Skill Sectors</div>
        </div>
        <div class="stat-box">
    ...
    <h2 style="font-family:'Sora';font-size:clamp(20px,3vw,30px);font-weight:800;margin-bottom:40px;text-align:center;color:#fff;">
        Explore Skilled Trade & Vocational Career Paths
    </h2>
    ...
    <div class="career-path-grid">
        ...
        <a href="{{ route('career.detail.page', $path->slug) }}" class="path-card">
            <div class="path-img-wrapper">
                <img
                    src="{{ $path->image ?? 'https://images.unsplash.com/photo-1621905251189-08b45d6a269e?auto=format&fit=crop&w=600&q=80' }}"
                    alt="{{ $path->name }}"
                    class="path-img"
                    loading="lazy"
                ...
                >
                <div class="path-icon">
                    <i class="fa-solid {{ $path->icon ?? 'fa-wrench' }}"></i>
                </div>
    ...
    <div style="text-align:center;margin-bottom:80px;">
        <a href="{{ route('explore.index') }}"
           style="display:inline-block;padding:18px 52px;font-size:16px;border-radius:30px;
                  background:linear-gradient(to right,#7c3aed,#8b5cf6);color:#fff;font-weight:700;
