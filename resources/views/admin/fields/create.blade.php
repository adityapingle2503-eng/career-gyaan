...
<div class="form-card">
  <form action="{{ route('admin.fields.store') }}" method="POST">
    ...
    <div class="form-group">
      ...
      <input type="text" name="name" id="name" class="form-control" placeholder="E.g. Engineering & Technology" required value="{{ old('name') }}">
      @error('name')
    ...
    <div class="form-group">
      ...
      <input type="text" name="icon" id="icon" class="form-control" placeholder="E.g. fa-laptop-code (without 'fa-solid' prefix is fine)" value="{{ old('icon', 'fa-briefcase') }}">
    ...
    <div class="form-row">
      <div class="form-group">
        ...
        <input type="color" name="color" id="color" class="form-control" style="height:44px; padding:4px;" value="{{ old('color', '#1a56db') }}">
        @error('color')
          <span style="color:#ef4444; font-size:12px; margin-top:4px; display:block;">{{ $message }}</span>
        @enderror
      </div>
      ...
      <div class="form-group">
        ...
        <input type="color" name="bg_color" id="bg_color" class="form-control" style="height:44px; padding:4px;" value="{{ old('bg_color', '#e8f0fe') }}">
        @error('bg_color')
          <span style="color:#ef4444; font-size:12px; margin-top:4px; display:block;">{{ $message }}</span>
        @enderror
      </div>
    ...
    <div class="form-group">
      ...
      <input type="text" name="cover_image" id="cover_image" class="form-control" placeholder="E.g. https://images.unsplash.com/photo-..." value="{{ old('cover_image') }}">
